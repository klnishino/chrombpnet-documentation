...
chrombpnet prep nonpeaks \
        ...
        -fl /scratch/tovar_root/tovar0/knishino/chrombpnet-encode-sm/data/splits/fold_3.json \
        -br /scratch/tovar_root/tovar0/knishino/chrombpnet-encode-sm/data/downloads/blacklist.bed.gz \
        -o /scratch/tovar_root/tovar0/knishino/chrombpnet-encode-sm/fold_3/data/output

# create bias model per fold
mkdir /scratch/tovar_root/tovar0/knishino/chrombpnet-encode-sm/fold_3/bias_model
chrombpnet bias pipeline \
        ...
        -c /scratch/tovar_root/tovar0/knishino/chrombpnet-encode-sm/data/downloads/hg38.chrom.sizes \
        -p /scratch/tovar_root/tovar0/knishino/chrombpnet-encode-sm/data/peaks_no_blacklist.bed \
        -n /scratch/tovar_root/tovar0/knishino/chrombpnet-encode-sm/fold_3/data/output_negatives.bed \
        -fl /scratch/tovar_root/tovar0/knishino/chrombpnet-encode-sm/data/splits/fold_3.json  \
        -b 0.5 \
        -o /scratch/tovar_root/tovar0/knishino/chrombpnet-encode-sm/fold_3/bias_model
...
chrombpnet pipeline \
        ...
        -n /scratch/tovar_root/tovar0/knishino/chrombpnet-encode-sm/fold_3/data/output_negatives.bed \
        -fl /scratch/tovar_root/tovar0/knishino/chrombpnet-encode-sm/data/splits/fold_3.json \
        -b /scratch/tovar_root/tovar0/knishino/chrombpnet-encode-sm/fold_3/bias_model/models/bias.h5 \
        -o /scratch/tovar_root/tovar0/knishino/chrombpnet-encode-sm/fold_3/chrombpnet_model/