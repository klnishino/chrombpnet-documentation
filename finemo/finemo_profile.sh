...
# hit calling
finemo call-hits -r /scratch/tovar_root/tovar0/knishino/chrombpnet-encode-sm/finemo/profile.npz \
	-m  /scratch/tovar_root/tovar0/knishino/chrombpnet-encode-sm/merged_profile_folds/modisco_w_500/modisco.h5 \
