#!/bin/bash
#
#SBATCH --job-name=modisco_counts_report
#SBATCH --time 14-
#SBATCH --ntasks=1
...
modisco report -i  /scratch/tovar_root/tovar0/knishino/chrombpnet-encode-sm/merged_counts_folds/modisco_w_500/modisco_results.h5 \
	-o report/ \
	-s /scratch/tovar_root/tovar0/knishino/chrombpnet-encode-sm/merged_counts_folds/modisco_w_500/report/ \
